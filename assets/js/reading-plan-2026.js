(function() {
  ...
  var sq = {"Ge":"genesis","Ex":"exodus","Lev":"leviticus","Nu":"numbers","Dt":"deuteronomy","Jos":"joshua","Jdg":"judges","Ru":"ruth","1Sa":"1-samuel","2Sa":"2-samuel","1Ki":"1-kings","2Ki":"2-kings","1Ch":"1-chronicles","2Ch":"2-chronicles","Ezr":"ezra","Ne":"nehemiah","Est":"esther","Job":"job","Ps":"psalms"};
  var sqCoverage = {
    availableCount: Object.keys(sq).length,
    totalCount: Object.keys(n).length,
    availableRangeEn: 'Genesis through Job',
    availableRangeZh: '創世記到約伯記'
  };
