---
layout: default
title: Annual Reading Plans
---

<div class="mb-8">
  <p class="card-en text-xs font-bold tracking-widest text-slate-400 uppercase mb-3">Reading Plan</p>
...
<div class="bg-indigo-50 rounded-3xl border border-indigo-200 p-6 shadow-sm mb-8">
  <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
    <div>
      <p class="card-en text-xs font-bold tracking-widest text-indigo-500 uppercase mb-2">Recommended</p>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
  <div class="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
    ...
    <h3 class="card-en" style="margin-top:0;font-size:1rem;">English Plan</h3>
  ...
  <div class="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
    <div class="text-2xl mb-3">📖</div>
    <h3 class="card-en" style="margin-top:0;font-size:1rem;">Chinese Plan</h3>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
  <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
    <p class="card-en text-xs font-bold tracking-widest text-slate-400 uppercase mb-2">Step 1</p>
  ...
  <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
    ...
    <p class="card-zh text-xs font-bold tracking-widest text-slate-400 uppercase mb-2">第 2 步</p>
    <p class="card-en font-semibold text-slate-900 mb-1">Use review days well</p>
    <p class="card-zh font-semibold text-slate-900 mb-1">善用複習日</p>
    <p class="card-en text-sm text-slate-500 mb-0">Each seventh day is meant for re-reading, journaling, prayer, and revisiting linked study questions.</p>
    <p class="card-zh text-sm text-slate-500 mb-0">每週第七天適合重讀、寫筆記、禱告，並回到已連結的學習問題。</p>
  </div>
  <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
    <p class="card-en text-xs font-bold tracking-widest text-slate-400 uppercase mb-2">Step 3</p>
    <p class="card-zh text-xs font-bold tracking-widest text-slate-400 uppercase mb-2">第 3 步</p>
    <p class="card-en font-semibold text-slate-900 mb-1">Move into deeper study</p>
    <p class="card-zh font-semibold text-slate-900 mb-1">進入更深入的查考</p>
    <p class="card-en text-sm text-slate-500 mb-0">After the reading, use the book study pages when you want slower reflection or group discussion.</p>
    <p class="card-zh text-sm text-slate-500 mb-0">讀完後若想更深入思想或小組討論，再進入書卷問題頁面。</p>
  </div>
</div>

<div class="bg-slate-50 rounded-3xl border border-slate-200 p-6 mb-8">
  <p class="card-en text-xs font-bold tracking-widest text-slate-400 uppercase mb-3">Reading Tips</p>
  <p class="card-zh text-xs font-bold tracking-widest text-slate-400 uppercase mb-3">閱讀建議</p>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
    <div class="card-en rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">Set a regular time each day so the plan becomes part of your normal rhythm.</div>
    <div class="card-zh rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">固定每天讀經時間，讓計劃真正成為生活節奏的一部分。</div>
    <div class="card-en rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">Keep a journal to capture repeated themes, questions, and applications.</div>
    <div class="card-zh rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">準備一本筆記，記下反覆出現的主題、問題與應用。</div>
    <div class="card-en rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">Begin each session with prayer and ask for clarity, humility, and obedience.</div>
    <div class="card-zh rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">每次開始前先禱告，求神賜下清楚、謙卑與順服的心。</div>
    <div class="card-en rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">Use the review days to slow down instead of only trying to catch up on volume.</div>
    <div class="card-zh rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">複習日的目標是放慢腳步，不只是補進度。</div>
  </div>
</div>

<p class="card-en" style="text-align:center;margin-top:2rem;"><a href="/bs/">← Back to Bible Study Portal</a></p>
<p class="card-zh" style="text-align:center;margin-top:2rem;"><a href="/bs/">← 返回聖經學習入口</a></p>
