...
<div class="mb-8">
  <p class="text-xs font-bold tracking-widest text-slate-400 uppercase mb-3">Linked Reflection</p>
  <h1 style="font-size:1.875rem;">❓ Study Questions</h1>
  <p class="text-slate-500">Use these book-based guides to observe, interpret, and apply Scripture. They connect directly with the daily calendar when a book has prepared questions.</p>
</div>
...
<h2 style="margin-top:0;">📖 律法書 Law Books (Genesis – Deuteronomy)</h2>
...
<h2>📖 歷史書 Historical Books (Joshua – 2 Kings)</h2>
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-8 mt-4">
  <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
...
<p class="text-xs font-bold tracking-widest text-slate-400 uppercase mb-4">Coming Soon</p>
...
<div class="bg-slate-50 rounded-3xl border border-slate-200 p-6 mb-8">
  <p class="text-xs font-bold tracking-widest text-slate-400 uppercase mb-3">How to Use These Questions</p>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
    <div class="rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">Read the biblical passage first before opening the questions.</div>
    <div class="rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">Work through the prompts slowly instead of trying to answer everything at once.</div>
    <div class="rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">Use the English and Chinese pages side by side if bilingual comparison helps you.</div>
    <div class="rounded-2xl bg-white border border-slate-200 p-4 text-sm text-slate-600">Download the plain-text copy from any book page when you want offline or printable study.</div>
  </div>
</div>

<p style="text-align:center;margin-top:2rem;"><a href="/bs/">← Back to Bible Study Portal</a></p>
